...
import com.ravikiran357.basic_ml_services.mail.SendMail;
...
//	There are many ways to resolve the bean, one is to replace mailSender variable with camelCase of required class (like sendMail)
...
//	}
	...
	public String hello() {
		...
		mailSender.send("mail@example.com", "Test sibject", "test body");
